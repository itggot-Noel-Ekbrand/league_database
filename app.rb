...
require 'json'
	...
	get ('/:username') do
		...
		slim(:index, locals:{ summoner_name:summoner_name, summoner_level:summoner_level, summoner_profile:summoner_profile, summoner_tier:summoner_tier, summoner_rank:summoner_rank,summoner_wins:summoner_wins })
	end
